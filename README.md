...
Note: you can get some stats (bundle size, download time) about the released version. E.g.:
https://bundlephobia.com/result?p=@adobe/adobe-client-data-layer@1.0.0-beta.3
